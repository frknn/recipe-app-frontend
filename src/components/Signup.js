...
function Signup(props) {
  return (
    <div className="signup">
      ...
      <input placeholder="E-mailiniz..." className="signup-email-input" type="email" name="email" id="emailId" />
      <input placeholder="Şifreniz..." className="two-col-input" type="password" name="email" id="passwordId" />
      <input placeholder="Şifre tekrar..." className="two-col-input" type="password" name="email" id="passwordId" />
